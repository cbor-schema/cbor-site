...
const config = {
  ...
  projectName: 'cbor-schema.github.io', // Usually your repo name.

  onBrokenLinks: 'warn', // or 'throw'
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/cbor-schema/cbor-site/tree/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          // },
          {
            href: 'https://github.com/cbor-schema',
            label: 'GitHub',
            position: 'right',
          },
        ],
            ...
            items: [
              {
                ...
                href: 'https://github.com/cbor-schema/cbor-site/discussions',
              },
            ],
          },
          {
            ...
            items: [
              ...
              {
                label: 'GitHub',
                href: 'https://github.com/cbor-schema/cbor-site',
              },
            ],
          },
        ],
